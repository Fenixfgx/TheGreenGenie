...
function getTestimonialsData() {
    return [
        ...
        {
            id: 2,
            name: window.getTranslation ? window.getTranslation('testimonial.2.name') : "June Mitchell",
            position: window.getTranslation ? window.getTranslation('testimonial.2.position') : "Directora de Importaciones",
